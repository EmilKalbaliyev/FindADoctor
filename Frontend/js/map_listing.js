	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Doctors': [
			{
				...
				location_latitude: 47.4981524, 
				location_longitude: 19.0390707,
				map_image_url: 'img/doctor_prof.jpg',
				...
				{
				name: 'Dr. Robert Carl',
				location_latitude: 47.4734229, 
				location_longitude: 19.0684634,
				map_image_url: 'img/doctor_prof.jpg',
				type: 'Psicologist',
				url_detail: 'detail-page.html',
			...
			{
				name: 'Dr. Mark Twain',
				location_latitude: 47.4795221, 
				location_longitude: 19.0671301,
				map_image_url: 'img/doctor_prof.jpg',
				type: 'Primary Care',
				url_detail: 'detail-page.html',
			...
			var mapOptions = {
				zoom: 12,
				center: new google.maps.LatLng(47.4892657, 19.0509318),
