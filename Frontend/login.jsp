		...
		<div class="bg_color_2">
			<div class="container margin_60_35">
				<div id="login">
					...
					<p class="text-center link_bright">Do not have an account yet? <strong>Register now!</strong></p>
					<strong>Create a </strong>  	&nbsp;
					<a type="button"  href="register.html" class="btn btn-primary">User account</a>
					<a type="button" href="register-doctor-working.html" class="btn btn-primary">Doctor account</a>
				</div>
				<!-- /login -->
			</div>
		</div>
